...
**Edit:** The file [noderedgateway POST.js](https://github.com/gitjps/watsonassistant-nodered-gateway/blob/master/noderedgateway%20POST.js) contains an additional function for a POST request (without the correponding WA & Node-RED JSONs).
